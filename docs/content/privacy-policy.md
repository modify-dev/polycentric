...
- harbor Android / iOS application
...
- IPs and other metadata: When you publish data to FUTO servers, we record the IP address you submitted data from, and other metadata such as time. We also may retain server logs which include the IP address of every request to our server.
...
- To understand how users experience the service, what features users benefit from, what works well, and what doesn’t.
...
- Retain server logs containing the IP address of all requests to FUTO servers, in so far as such logs are kept, no more than 90 days.

You can request and download an archive of your content, including your posts, media attachments, profile picture, and header image.

You may irreversibly delete your account at any time. You also may irreversibly delete specific posts or content at any time.
...
Legal requirements can be different if this user / service is in another jurisdiction.

FUTO will delete any data from FUTO servers belonging to users in violation of this policy.
...
[legal@futo.org](mailto:legal@futo.org)
