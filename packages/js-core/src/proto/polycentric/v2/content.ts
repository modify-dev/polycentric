    ...
    super('polycentric.v2.ContentDigest', [
      {
        ...
        kind: 'enum',
        T: () => [
          'polycentric.v2.ContentDigestType',
          ContentDigestType,
          'CONTENT_DIGEST_TYPE_',
        ],
      },
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* polycentric.v2.Post post */ 2:
          message.contentBody = {
            oneofKind: 'post',
            post: Post.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.contentBody as any).post,
            ),
          };
          break;
        case /* polycentric.v2.Delete delete */ 3:
          message.contentBody = {
            oneofKind: 'delete',
            delete: Delete.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.contentBody as any).delete,
            ),
          };
          break;
        case /* polycentric.v2.Follow follow */ 4:
          message.contentBody = {
            oneofKind: 'follow',
            follow: Follow.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.contentBody as any).follow,
            ),
          };
          break;
        case /* polycentric.v2.Block block */ 5:
          message.contentBody = {
            oneofKind: 'block',
            block: Block.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.contentBody as any).block,
            ),
          };
          break;
        case /* polycentric.v2.Reaction reaction */ 6:
          message.contentBody = {
            oneofKind: 'reaction',
            reaction: Reaction.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.contentBody as any).reaction,
            ),
          };
          break;
        case /* polycentric.v2.ProfileUpdate profile_update */ 7:
          message.contentBody = {
            oneofKind: 'profileUpdate',
            profileUpdate: ProfileUpdate.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.contentBody as any).profileUpdate,
            ),
          };
          break;
        case /* polycentric.v2.Identity identity */ 8:
          message.contentBody = {
            oneofKind: 'identity',
            identity: Identity.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.contentBody as any).identity,
            ),
          };
          break;
        default:
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* optional polycentric.v2.PostReply reply */ 2:
          message.reply = PostReply.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.reply,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* polycentric.v2.EventKey root */ 1:
          message.root = EventKey.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.root,
        ...
        case /* polycentric.v2.EventKey parent */ 2:
          message.parent = EventKey.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.parent,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* polycentric.v2.EventKey event_key */ 1:
          message.eventKey = EventKey.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.eventKey,
  ...
  constructor() {
    super('polycentric.v2.Reaction', [
      ...
      },
      {
        ...
        name: 'opinion',
        kind: 'enum',
        T: () => ['polycentric.v2.Opinion', Opinion, 'OPINION_'],
      },
    ]);
  }
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* optional polycentric.v2.Image avatar */ 2:
          message.avatar = Image.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.avatar,
        ...
        case /* optional polycentric.v2.Image banner */ 3:
          message.banner = Image.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.banner,
...
class Blob$Type extends MessageType<Blob> {
  ...
  create(value?: PartialMessage<Blob>): Blob {
    ...
    message.mimeType = '';
    message.size = 0n;
    if (value !== undefined) reflectionMergePartial<Blob>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    ...
    /* int64 size = 3; */
    if (message.size !== 0n) writer.tag(3, WireType.Varint).int64(message.size);
    let u = options.writeUnknownFields;
    if (u !== false)
      (u == true ? UnknownFieldHandler.onWrite : u)(
        this.typeName,
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* polycentric.v2.Blob blob */ 1:
          message.blob = Blob.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.blob,
...
export const ContentService = new ServiceType('polycentric.v2.ContentService', [
  {
    name: 'SyncContent',
    options: {},
    I: SyncContentRequest,
    O: SyncContentResponse,
  },
]);
